                ...
                <Container className="content-container">
                    <div className="profile-card d-flex flex-column flex-md-row align-items-center gap-4 p-4 mb-5 shadow-lg" style={{ background: '#0d0e15', border: '1px solid rgba(255,255,255,0.08)' }}>
                        ...
                        <div className="flex-grow-1 text-center">
                            ...
                            <div className="d-flex justify-content-center gap-4 text-secondary small" style={{ opacity: 0.6 }}>
                                <span className="d-flex align-items-center gap-2">
                                    ...
                                    {startup.metrics?.total_views ?? 0} views
                                </span>
                                <span className="d-flex align-items-center gap-2">
                                    ...
                                    {startup.metrics?.total_upvotes ?? 0} upvotes
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="action-buttons d-flex align-items-start gap-2 flex-shrink-0 align-self-start">
                            {startup.website_url && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="text-secondary text-decoration-none small d-flex align-items-center px-2"
                                    style={{ height: 42, opacity: 0.5 }}
                                >
                                    Visit Website
                                </a>
                            )}
                                        ...
                                        {startup.website_url && (
                                            <div className="d-flex flex-column gap-2">
                                                ...
                                                <a href={startup.website_url} target="_blank" rel="noreferrer"
                                                    className="link-item d-flex justify-content-between align-items-center text-decoration-none p-2"
